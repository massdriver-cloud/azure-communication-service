...
The Azure Communication Service endpoint artifact will output the API endpoint of the Communication service so that your applications can natively use it as an environment variable.
